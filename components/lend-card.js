                    ...
                    <div className="flex gap-4 ">
                        ...
                        <div className="flex flex-col w-full justify-between &quot; py-1">
                            <div className="flex items-center gap-1 justify-between w-full ">
                                <div className="sm:text-2xl text-xl font-extrabold leading-5">Bitcoin Frogs</div>
                            ...
                            <div>
                                <div className="text-sm font-semibold">Total Volume: 1009.73 BTC</div>
                            </div>
                        </div>
                    </div>
                    <div className="mt-5">
                        <div className="w-full grid grid-cols-3 grid-rows-1 gap-2.5" >
                            <div className="p-3 rounded-xl border border-black/20">
                                <div className=" font-medium sm:text-sm text-xs">Floor</div>
                                <div className="flex font-bold text-sm sm:text-base mt-1">
                                    ...
                                    <div className="text-black">0.264</div>
                                    <div className=" "></div>
                                </div>
                            </div>
                            <div className="p-3 rounded-xl border border-black/20">
                                <div className=" font-medium sm:text-sm text-xs">Duration</div>
                                <div className="flex font-bold text-sm sm:text-base mt-1">
                                    <div className="text-black">16</div><p className=" ml-1">Days</p>
                                </div>
                            </div>
                            <div className="p-3 rounded-xl border border-black/20">
                                <div className=" font-medium sm:text-sm text-xs">APY</div>
                                <div className="flex font-bold text-sm sm:text-base mt-1">
